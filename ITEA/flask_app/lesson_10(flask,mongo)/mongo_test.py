...
# для группировок нужно переходить уже на уровень нативных запросов (не рассматриваем тут по крайней мере пока).
# Второй вариант - получить данные на уровень Python и уже тут продолжить с ними работу.
